...
![](Pasted%20image%2020260531115120.png)
Нажимаю `Создать новый диск`:
![](Pasted%20image%2020260531115154.png)
Настраиваю диск и нажимаю `Создать`:
![](Pasted%20image%2020260531115244.png)
Диск добавился:
![](Pasted%20image%2020260531115409.png)

Проверяю добавление диска с ВМ:
![](Pasted%20image%2020260531115518.png)
Создаю раздел на диске:
```bash
sudo fdisk /dev/vdb
```
![](Pasted%20image%2020260531115639.png)
Появился раздел:
![](Pasted%20image%2020260531115720.png)
Выполняю форматирование раздела в файловую систему ext4:
```bash
sudo mkfs.ext4 /dev/vdb1
```
![](Pasted%20image%2020260531115831.png)
...
df -h | grep external
```
![](Pasted%20image%2020260531120248.png)
Узнаю UUID диска:
```bash
sudo blkid /dev/vdb1
```
![](Pasted%20image%2020260531120340.png)
...
```
![](Pasted%20image%2020260531120944.png)
...
```
![](Pasted%20image%2020260531121846.png)
...
SHOW data_directory;
```
![](Pasted%20image%2020260531122227.png)
Узнаю расположение postgresql.conf:
```Psql
SHOW config_file;
```
![](Pasted%20image%2020260531122316.png)
...
```
![](Pasted%20image%2020260531123320.png)
...
```
![](Pasted%20image%2020260531123632.png)